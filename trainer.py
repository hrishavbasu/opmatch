...
def train(args, labeled_trainloader, unlabeled_dataset, test_loader, val_loader,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx in range(args.eval_step):
            ...
            wandb.log({'batch' : batch_idx, "loss_x" : losses_x.avg, "loss_o" : losses_o.avg, "loss_oem": losses_oem.avg, "loss_socr":losses_socr.avg, "loss_fix":losses_fix.avg, "lr":[group["lr"] for group in optimizer.param_groups][0]})
